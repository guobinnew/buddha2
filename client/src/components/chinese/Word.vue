<template>
    <div style="overflow: hidden;">
        <el-button-group>
            <el-button type="primary" icon="fa fa-arrow-left" @click="onClickPrev" :disabled="buttons.prev">上一个单词
            </el-button>
            <el-button type="success" icon="fa fa-arrow-right" @click="onClickNext" :disabled="buttons.next">下一个单词
            </el-button>
            <el-button type="warning" icon="fa fa-repeat" @click="onClickAgain" :disabled="buttons.again">再读一遍
            </el-button>
            <el-button type="danger" icon="fa fa-buysellads" @click="onClickAnswer" :disabled="buttons.answer">查看答案
            </el-button>
        </el-button-group>
        <el-row :gutter="20">
            <el-col :span="8">
